...
read_csv("C:/Users/ksrikanth/Documents/Data/DSD_patient_reference_export 16th Feb 22.csv", skip =2)
...
#create var of HIV diagnosis time based on diagnosis year
 ...
 #Save tidied data to Dataout folder
 write_csv(df_clean, "Dataout/20220223-DSD-preference-clean.csv")
